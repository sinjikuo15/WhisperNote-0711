            ...
            <div class="flex justify-end mt-3">
              <div class="modal__action">
                ...
                <div class="hidden" id="editModeBtn">
                  <button type="button" class="justify-center rounded-md border border-transparent shadow-sm px-4 py-2 btn-primary text-base font-medium text-white mr-2 sm:w-auto sm:text-sm" @click="updateCharacter">儲存</button>
